...
<Figure caption="Isolate the temperature sensor" src="/img/probe-glue.png" />
</details>
...
<div className="figure-container">
    <Figure caption="Open the clamshell connector" src="/img/probe1.png" />
    <Figure caption="Insert the cable (blue side up)" src="/img/probe2.jpg" />
    <Figure caption="Close the clamshell" src="/img/probe3.jpg" />
</div>
...
<Figure caption="The case is easiest to remove if pushing up from the USB-C port" src="/img/case1.png" />

<div className="figure-container">
    <Figure caption="Insert the cable (blue side up)" src="/img/case3.jpg" />
    <Figure caption="Insert the top part of the case" src="/img/case4.jpg" />
</div>
...
<Figure caption="Sensus powered via USB-C" src="/img/power1.jpg" />

Alternatively, you can open the back of the case to insert a CR2032 battery, as shown in the images below:
  
<Figure caption="Rotate counter-clockwise to open" src="/img/power2.png" />

<div className="figure-container">
    <Figure caption="" src="/img/power3.png" />
    <Figure caption="Insert battery with positive side up" src="/img/power4.png" />
</div>
